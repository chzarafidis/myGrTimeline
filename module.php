...
namespace chzarafidis\WebtreesModules\History\myGrTimeline;
   ...
   /**
    ...
    public function historicEventsAll(): Collection
    {
        ...
        return new Collection([
            ...
            "1 EVEN Δημιουργία του Κυβερνείου του Καρς (Συνθήκη Αγίου Στεφάνου)\n2 TYPE Political\n2 DATE 1878\n2 NOTE Μετά τον Ρωσοτουρκικό πόλεμο, η Οθωμανική Αυτοκρατορία παραχωρεί την περιοχή του Καρς στη Ρωσία. Αυτό οδηγεί σε μαζική μετανάστευση Ελλήνων του Πόντου στην περιοχή. [wikipedia gr](https://el.wikipedia.org/wiki/Συνθήκη_του_Αγίου_Στεφάνου )",
